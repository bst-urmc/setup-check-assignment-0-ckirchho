...
#usethis::create_from_github("https://github.com/bst-urmc/setup-check-assignment-0-ckirchho.git",
#   destdir="~/Documents/URochester/BST430/", fork=FALSE)
...
-  Let git know about your github username and email by editing this as appropriate and entering it into the Console:
  ...
  scope = "user",
  user.name = "Christopher Kirchhoff",
  user.email = "christopher_kirchhoff@urmc.rochester.edu")
  ```
